    ...
    <StyledWrapper>
      <div className="button-container" onClick={() => window.open('https://discord.com/users/1365827144663564380')}>
        <button className="button">
          {/* Discord Icon */}
          <svg style={{ height: '2dvh' }} xmlns="http://www.w3.org/2000/svg" fill="blaack" viewBox="0 0 48 48">
        ...
        <button className="button" onClick={() => window.open('https://github.com/dwellerx')}>
          {/* GitHub Icon */}
          <svg style={{ height: '2dvh', position : "relative" }} xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24">
